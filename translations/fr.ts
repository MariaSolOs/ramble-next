...
const frenchTranslation: TranslationRecord = {
    Home: {
        experienceTitle1: "Des expériences à votre image", 
        experienceTitle2: 'votre image', 
    ...
    CreateExperience: {
        stripeRedirectMessage1: 'Vous y êtes presque! Avant de débuter, nous avons besoin que vous configuriez vos informations de paiement avec Stripe.',
        stripeRedirectMessage2: "Si vous avez besoin d'aide, faites-le nous savoir!",
    ...
    BuilderSlides_Pricing: {
        ...
        creatorFee: '- 20% de frais de Créateur',
